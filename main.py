...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        player_character = PlayerCharacter('image/pemain.png', 375, 700, 50, 50)
        enemy_0 = EnemyCharacter('image/musuh1.png', 20, 600, 50, 50)
        # Kecepatan naik ketika telah mencapai Goal
        enemy_0.SPEED *= level_speed

        # Membuat musuh baru
        enemy_1 = EnemyCharacter('image/musuh2.png', self.width - 40, 400, 50, 50)
        enemy_1.SPEED *= level_speed

        # Membuat musuh baru
        enemy_2 = EnemyCharacter('image/musuh3.png', 20, 50, 50, 50)
        enemy_2.SPEED *= level_speed

        OnePiece = GameObject('image/onepiece.png', 375, 50, 50, 50)
...
pygame.init()
new_game = Game('image/latar.png', SCREEN_TITLE, SCREEN_WIDTH, SCREEN_HEIGHT)
